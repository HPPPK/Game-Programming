...
| T21 | AI Easy | AI Easy turn behaviour works. | Easy AI takes simple valid turns. | Manual verification required | Needs manual verification | `Assets/Scripts/Core/AIPrototypeTurnManager.cs` | To be completed after manual verification |
| T22 | AI Medium | AI Medium behaviour works if implemented. | Medium AI takes valid turns with stronger choices. | Manual verification required | Needs manual verification | `Assets/Scripts/Core/AIPrototypeTurnManager.cs` | To be completed after manual verification |
| T23 | AI Hard | AI Hard behaviour works if implemented. | Hard AI takes valid turns with higher pressure. | Manual verification required | Needs manual verification | `Assets/Scripts/Core/AIPrototypeTurnManager.cs` | To be completed after manual verification |
