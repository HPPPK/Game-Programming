...
| Core gameplay implementation | Build playable turn, card, tower, enemy, path, and result systems. | Implemented core student-authored systems under `FinalGame/CanalTD/Assets/Scripts`. | `Assets/Scripts/Core`, `Assets/Scripts/Card`, `Assets/Scripts/Tower`, `Assets/Scripts/Enemy`, `Assets/Scripts/Path` | Multiple systems needed to work together inside scenes, not only as separate scripts. | README and this log now summarise the main systems without a separate system-overview file. | Main gameplay systems are easier for markers to inspect. |
...
| UI, tutorial, audio, result | `Assets/Scripts/UI`, `Assets/Scripts/Tutorial`, `ResultScene` | Provides player feedback, onboarding, sound feedback, and match completion display. |
| AI and online extension | `AIPrototypeTurnManager.cs`, `Assets/Scripts/Networking` | AI supports the primary assessment route; Online is retained as an implemented extension. |
...
Examples of tracked work include enemy routing [#29](https://github.com/HPPPK/Game-Programming/issues/29), home/menu flow [#61](https://github.com/HPPPK/Game-Programming/issues/61), mode selection [#62](https://github.com/HPPPK/Game-Programming/issues/62), audio integration [#87](https://github.com/HPPPK/Game-Programming/issues/87), online scene transition [#89](https://github.com/HPPPK/Game-Programming/issues/89), online lifecycle [#91](https://github.com/HPPPK/Game-Programming/issues/91), player HUD [#93](https://github.com/HPPPK/Game-Programming/issues/93), and tutorial tasks [#95](https://github.com/HPPPK/Game-Programming/issues/95)-[#97](https://github.com/HPPPK/Game-Programming/issues/97).
