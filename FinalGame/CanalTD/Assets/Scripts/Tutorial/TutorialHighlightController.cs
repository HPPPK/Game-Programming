/*
 * File: TutorialHighlightController.cs
 *
 * Purpose:
 * Implements TutorialHighlightController for the tutorial layer of Rail Rumble and supports the playable vertical slice of the project.
 *
 * Attached GameObject:
 * Tutorial scene objects, guide overlays, or scripted onboarding helpers.
 *
 * Main responsibilities:
 * - Provide the runtime behaviour for TutorialHighlightController within the tutorial system.
 ...
 *
 * Testing notes:
 * - Verify TutorialHighlightController in the scene or prefab where it is used and confirm the main happy path still works.
 */
using UnityEngine;
